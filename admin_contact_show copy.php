...
$sql = "SELECT id, name, email, subject, message, submitted_at, comments FROM contacts";
...
<!-- ===============>> Header section end here <<================= -->
  ...
  <section class="blog_table mt-5">
    <div class="section-header section-header--max50">
      <h2 class="mb-10 mt-minus-5">User <span> Contact</span> List</h2>

      <a href="contact.html" class="btn bg-primary text-light btn-lg mt-3">Add Contact</a>
    </div>
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<a class='delete' href='admin_contact_delete.php?id=" . $row['id'] . "'>Delete</a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                } else {
