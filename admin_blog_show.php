...
$sql = "SELECT id, title, description, image_path, upload_date FROM blog_posts";
...
<!-- ===============>> Header section end here <<================= -->
  ...
  <section class="blog_table mt-5">
    <div class="section-header section-header--max50">
      <h2 class="mb-10 mt-minus-5"> <span>Blog Post</span> Table</h2>

      <a href="blog_post.html" class="btn bg-primary text-light btn-lg mt-3">Add Blog</a>
    </div>
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><img src='" . htmlspecialchars($row['image_path']) . "' alt='Image'></td>";
                        echo "<td>" . htmlspecialchars($row['upload_date']) . "</td>";
                        echo "<td class='action-buttons'>";
echo "<a class='edit' href='blog_post_edit.php?id=" . $row['id'] . "' style='background-color: #a2d2ff; color: #000; padding: 5px 10px; text-decoration: none; border-radius: 5px;'>Edit</a> ";
echo "<a class='delete' href='admin_blog_delete.php?id=" . $row['id'] . "' style='background-color: #ff8fab; color: #000; padding: 5px 10px; text-decoration: none; border-radius: 5px;'>Delete</a>";
echo "</td>";
echo "</tr>";
