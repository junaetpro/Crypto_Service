...
$sql = "SELECT * FROM blog_posts ORDER BY upload_date DESC";
...
<!-- Mirrored from thetork.com/demos/html/bitrader/blogs.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Nov 2024 14:16:30 GMT -->
        ...
        <div class="menu-area">
          <ul class="menu menu--style1">
            ...
            <li>
              ...
              <ul class="submenu">
                <li><a href="service_d1.html">FXBANK VIP & Gold</a></li>
                <li><a href="service_d2.html">FXBANK ICCM VIP</a></li>
                <li><a href="service_d3.html">FXBANK Account Management Service</a></li>
                <li><a href="service_d4.html">Best Forex Signals</a></li>
                <li><a href="service_d5.html">Free Forex Signals</a></li>
            ...
            <li>
              ...
              <ul class="submenu">
                ...
                <li><a href="Ticker.html">Tickers</a></li>
...
<!-- ===============>> Header section end here <<================= -->
  ...
  <div class="section-header section-header--max50">
      <h2 class="  mt-minus-5"> Our <span>Blog </span>Here</h2>
    </div>
    <div class="container">
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        // Truncate title to the first 40 characters
        $shortTitle = mb_substr(strip_tags(trim($row['title'])), 0, 40, 'UTF-8');
        
        // Truncate description to the first 200 characters
        $shortDescription = mb_substr(strip_tags(trim($row['description'])), 0, 200, 'UTF-8');
        
        // Format the upload date
        $uploadDate = date("F j, Y", strtotime($row['upload_date'])); // Example: December 7, 2024
        
        echo "<div class='col-sm-6 col-lg-4'>
                <a href='blog_detais.html'>
                    <div class='blog__item' data-aos='fade-up' data-aos-duration='800' style='padding-bottom: 50px;'>
                        <div class='blog__item-inner blog__item-inner--style2'>
                            <div class='blog__thumb'>
                                <img src='" . htmlspecialchars($row['image_path']) . "' alt='blog Images' style='width:100%; height:180px;'>
                            </div>
                            <div class='blog__content'>
                                <div class='blog__meta'>
                                    <div class='blog__date'>$uploadDate</div> <!-- Added upload date -->
                                </div>
                                <h5 class='style2'>" . htmlspecialchars($shortTitle) . "...</h5>
                                <p class='mb-15'>" . htmlspecialchars($shortDescription) . "...</p>
                            </div>
                        </div>
                    </div>
                </a>
...
<!-- Mirrored from thetork.com/demos/html/bitrader/blogs.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Nov 2024 14:16:35 GMT -->
</html>